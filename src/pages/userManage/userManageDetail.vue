<template>
    <div>
        <div class="page_view">
           ...
           <div class="user_head">
               ...
               <div class="user_data">
                   <ul>
                       <li>
                           <p><span class="left">昵称</span><span class="right">岁月清风</span></p>
                           <p><span class="left">姓名</span><span class="right">雷三</span></p>
                           <p><span class="left">公司</span><span class="right">南方设计</span></p>
                       </li>
                        <li>
                            <p><span class="left">用户类型</span><span class="right">认证会员</span></p>
                            <p><span class="left">手机号</span><span class="right">18965326650</span></p>
                            <p><span class="left">职位</span><span class="right">设计师</span></p>
                       </li>
                        <li>
                           <p><span class="left">剩余免费次数</span><span class="right">--</span></p>
        ...
        <div class="page_view">
            <h5 class="h5_title"><i></i><span>估算记录</span></h5>
            <el-table
                ref="multipleTable"
                :data="tableData"
                tooltip-effect="dark"
