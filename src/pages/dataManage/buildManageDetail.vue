<template>
    <div>
        <div class="page_view">
            ...
            <el-form :inline="true" :model="formInline" ref="formInline"  class="demo-form-inline form" size='medium'>
                <el-form-item label="项目区位" class="middle">
                    <SelectOption @choseProvince="choseProvince" @choseCity="choseCity" :coreState="false" ref="myChild"/>
                </el-form-item>
        ...
        <PriceTip :showpreview.sync="showpreview" :diaTitle="diaTitle" @sendMessage="sendMessage" :paramTips="paramTips" :coreState="coreState"/>
    </div>
</template>
...
export default {
    ...
    mounted(){
        this.$route.meta.name = this.$route.params.data + '分类单价'
    },
    methods:{
        //返回
        backSubmit(){
